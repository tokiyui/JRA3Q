...
z500 = ax.contour(ds4['lon'], ds4['lat'], ds4['hgt'].sel(level=500.0), levels=np.arange(4980, 6000, 60), colors='black', linewidths=0.01, linestyles='solid', transform=latlon_proj)
