...
dss['prmsl'] = (["lat", "lon"], np.where(w <= 15, cv2.bilateralFilter(dss['prmsl'].values.astype('uint8'), d=15, sigmaColor=75, sigmaSpace=75), dss['prmsl'].values) * units(elem_units[3]))
