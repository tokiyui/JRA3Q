...
print(grbs[1].shape,dss['prmsl'].shape)
...
#dss['prmsl'] = (["lat", "lon"], np.where(dss['surf'] <= 150000, gaussian_filter(dss['prmsl'].values, sigma=1), dss['prmsl'].values) * units(elem_units[3]))
