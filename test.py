...
#dss['prmsl'] = (["lat", "lon"], np.where(w <= 26.5, gaussian_filter(dss['prmsl'].values, sigma=3), dss['prmsl'].values) * units(elem_units[3]))
#dss['prmsl'] = (["lat", "lon"], np.where(w <= 59.5, gaussian_filter(dss['prmsl'].values, sigma=2), dss['prmsl'].values) * units(elem_units[3]))
#dss['prmsl'] = (["lat", "lon"], np.where(w <= 100, gaussian_filter(dss['prmsl'].values, sigma=1), dss['prmsl'].values) * units(elem_units[3]))
